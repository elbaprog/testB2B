    ...
    <div class="page-content">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.module') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-sm-10">
                                        <select name="category_id" class="form-select" aria-label="Default select example">
                                            ...
                                            @foreach ($categories as $cat)
                                                <option value="{{ $cat->id }}"
                                                    {{ $cat->id == $modules->category_id ? 'selected' : '' }}>
                                                    {{ $cat->category }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="title" value="{{ $modules->title }}" class="form-control"
      ...
      {{ $modules->description }}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ asset($modules->image) }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
